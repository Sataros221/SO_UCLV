...
#define MAX_FARMERS 12 //Aumentado de 10 a 12
#define NORTH 0
#define SOUTH 1
#define MAX_CONSECUTIVE 4  // Incrementado de 3 a 4
...
void cross_bridge(int direction, int farmer_id) {
    ...
    sleep(5);  // Reducido de 10 a 5 segundos
}
...
int main() {
    ...
    int farmer_data[MAX_FARMERS][2];  // [direction, id]
     ...
     // Nueva secuencia con 12 agricultores
    int order[MAX_FARMERS] = {0, 1, 1, 1, 0, 0, 0, 1, 1, 0, 1, 0};
