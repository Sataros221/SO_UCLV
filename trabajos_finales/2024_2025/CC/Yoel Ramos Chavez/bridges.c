...
#define MAX_FARMERS 8 // Reducido de 10 a 8 agricultores
#define NORTH 0
#define SOUTH 1
#define MAX_CONSECUTIVE 4 // Aumentado a 4 consecutivos en la misma dirección
...
void cross_bridge(int direction, int farmer_id)
{
    ...
    sleep(5); // Reducido el tiempo de cruce de 10 a 5 segundos
}
...
int main()
{
    ...
    int order[MAX_FARMERS] = {0, 0, 1, 1, 0, 1, 0, 1}; // Secuencia alternada modificada
